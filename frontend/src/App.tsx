...
function IntegrationCard({ integration, bootstrap, blingConfig, blingOAuth }: { integration: Integration; bootstrap: BootstrapState; blingConfig: BlingConfigAdapter; blingOAuth: BlingOAuthAdapter }) {
...
type AppProps = { bootstrapAdapter?: BootstrapAdapter; blingPreviewAdapter?: BlingPreviewAdapter; blingImportAdapter?: BlingImportAdapter; blingConfigAdapter?: BlingConfigAdapter; blingOAuthAdapter?: BlingOAuthAdapter }
function App({ bootstrapAdapter, blingPreviewAdapter, blingImportAdapter, blingConfigAdapter, blingOAuthAdapter }: AppProps = {}) {
