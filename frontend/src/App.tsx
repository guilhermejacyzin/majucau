...
import { createBlingPreviewAdapter, createBootstrapAdapter, type BlingPreviewAdapter, type BootstrapAdapter, type BootstrapIntegration, type BootstrapState } from './bootstrap'
import './App.css'
...
function BlingImportPanel({ adapter }: { adapter: BlingPreviewAdapter }) {
...
type AppProps = { bootstrapAdapter?: BootstrapAdapter; blingPreviewAdapter?: BlingPreviewAdapter }
function App({ bootstrapAdapter, blingPreviewAdapter }: AppProps = {}) {
