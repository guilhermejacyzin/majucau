...
import { createBlingImportAdapter, createBlingPreviewAdapter, createBootstrapAdapter, type BlingImportAdapter, type BlingPreviewAdapter, type BootstrapAdapter, type BootstrapIntegration, type BootstrapState } from './bootstrap'
import './App.css'
...
function IntegrationsView({ bootstrap, blingPreview, blingImporter }: { bootstrap: BootstrapState; blingPreview: BlingPreviewAdapter; blingImporter: BlingImportAdapter }) {
...
type AppProps = { bootstrapAdapter?: BootstrapAdapter; blingPreviewAdapter?: BlingPreviewAdapter; blingImportAdapter?: BlingImportAdapter }
function App({ bootstrapAdapter, blingPreviewAdapter, blingImportAdapter }: AppProps = {}) {
